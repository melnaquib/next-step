...
parameter_types! {
	...
	pub const NextStepReservationFee: u32 = 1;

	pub const NextStepStrNameMaxLength: u32 = 256;
	pub const NextStepMaxActorsPerRole: u32 = 256;
	pub const NextStepActorHierDepth: u32 = 3;
	pub const NextStepRoleMaxActorAssigneeCount: u32 = 1;
}

impl pallet_next_step::Config for Runtime {
	...
	type ReservationFee = NextStepReservationFee;
	...
	type StrNameMaxLength = NextStepStrNameMaxLength;
	type ActorHierDepth = NextStepActorHierDepth;
	type MaxActorsPerRole = NextStepMaxActorsPerRole;
	type RoleMaxActorAssigneeCount = NextStepRoleMaxActorAssigneeCount;
